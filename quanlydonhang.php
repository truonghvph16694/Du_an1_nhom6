                            ...
                            <div class="user-dashboard-tab flex-column flex-md-row">
                                <div class="user-dashboard-tab__head nav flex-md-column" role="tablist"
                                    ...
                                    <a class="nav-link" data-toggle="pill" role="tab" href="admin.php"
                                        ...
                                        <a class="nav-link active" href="quanlydonhang.php">Quản lý đơn hàng</a>
    ...
    <tbody>
        <?php foreach ($kq1 as $key => $value) : ?>
            <tr>
                ...
                <td><?= $value['time'] ?></td>
                <td>
                <a href="edit-donhang.php?order_id=<?= $value['order_id'] ?>">Thay đổi trạng thái đơn hàng</a>  --------------- <br>
                <a onclick="return confirm('Bạn có muốn xóa đơn hàng này không?')" href="xoa-donhang.php?order_id=<?= $value['order_id'] ?>">Xóa</a>
                </td>
