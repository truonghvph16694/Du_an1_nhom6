                            ...
                            <div class="user-dashboard-tab flex-column flex-md-row">
                                <div class="user-dashboard-tab__head nav flex-md-column" role="tablist"
                                    ...
                                    <a class="nav-link" data-toggle="pill" role="tab" href="admin.php"
                                        ...
                                        <a class="nav-link active" href="quanlydanhmuc.php">Quản lý danh mục</a>
                                        <a class="nav-link" href="logout.php">Đăng xuất</a>
                                  
                                </div> 
                                <div class="user-dashboard-tab__content tab-content"><a href="them-danhmuc.php">Thêm danh mục</a> 
    ...
    <tbody>
        <?php foreach ($kq1 as $key => $value) : ?>
            <tr>
                ...
                <td>
                <a href="edit-danhmuc.php?cate_id=<?= $value['cate_id'] ?>">Sửa /</a>
                <a onclick="return confirm('Bạn có muốn xóa danh mục này không?')" href="xoa-danhmuc.php?cate_id=<?= $value['cate_id'] ?>">Xóa</a>
