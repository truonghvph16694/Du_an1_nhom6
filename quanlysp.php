                        ...
                        <div class="col-12">
                            <div class="user-dashboard-tab flex-column flex-md-row">
                                <div class="user-dashboard-tab__head nav flex-md-column" role="tablist"
                                    ...
                                    <a class="nav-link" data-toggle="pill" role="tab" href="admin.php"
                                        aria-controls="dashboard" aria-selected="true">Quản lý tài khoản</a>
                                        <a class="nav-link" href="quanlycmt.php">Quản lý bình luận</a>
                                        <a class="nav-link active" href="quanlysp.php">Quản lý sản phẩm</a>
                                ...
                                <div class="user-dashboard-tab__content tab-content">
                                    ...
                                    <a href="them-sp.php">Thêm sản phẩm</a>  
    ...
    <tbody>
        ...
        <?php foreach ($users as $key => $value) : ?>
            <tr>
                ...
                <td>
                    <img src="uploads/<?=  $value['pro_image'] ?>" width="100">
                </td>
                
                <td><?= $value['pro_price'] ?></td>
                <td><?= $value['pro_sale'] ?></td>
                <td><?= $value['pro_intro'] ?></td>
                
               
                <td>
               
                <a href="edit-sp.php?pro_id=<?= $value['pro_id'] ?>">Sửa /</a>
                    <a onclick="return confirm('Bạn có muốn xóa sản phẩm này không?')" href="xoa-sp.php?pro_id=<?= $value['pro_id'] ?>">Xóa</a>
                </td>
