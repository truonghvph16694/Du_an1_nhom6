...
<body>
    ...
    <div class="wrapper">
                                        ...
                                        <div class="table-content table-responsive">
                                            <table class="table text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="product-remove text-start"><a href="themgiohang.php?idsp=<?php echo $key1['id']?>&action=delete"><i
                                                                    class="dl-icon-close"></i></a></td>
                                                        <td class="product-thumbnail text-start">
                                                            <img src="assets/img/products/<?php echo $key1['image'] ?>"
                                                                alt="Product Thumnail">
                                                        </td>
                                                        <td class="product-name text-start wide-column">
                                                            <h3>
                                                                <a href="product-details.html"><?php echo $key1['name'] ?></a>
                                                            </h3>
                                                        </td>
                                                        <td class="product-price">
                                                            <span class="product-price-wrapper">
                                                                <span class="money"><?php echo number_format($key1['price'])  ?></span>
                                                            </span>
                                                        </td>
                                                        ...
                                                        <td class="product-quantity">
                                                            <div class="">
                                                                ...
                                                                <input type="number" class="quantity-input" name="qty"
                                                                    id="qty-1" value="<?php echo $key1['quantity'] ?>" min="1">
                                                                
                                                            </div>
                                                        </td>
                                                        <td class="product-total-price">
                                                            <span class="product-price-wrapper">
                                                                <span class="money"><?php echo number_format($key1['price'] * $key1['quantity'])  ?></span>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                        ...
                                        <table class="table order-table">
                                            <tbody>
                                                ...
                                                <tr class="order-total">
                                                    ...
                                                    <td>
                                                        <span class="product-price-wrapper">
                                                            <span class="money"><?php echo number_format($tongtien + 35000) ?></span>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </tbody>
        ...
        <?php }
                                                    ...
                                                    ?>
                                                    <h3><a href="formdangnhap.php">Bạn phải Đăng nhập thì mới có thể sử dụng giỏ hàng </a></h3>
                                                    <?php   } ?>
        <!-- Main Content Wrapper Start -->
